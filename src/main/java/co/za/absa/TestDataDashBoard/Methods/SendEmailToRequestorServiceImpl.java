...
public class SendEmailToRequestorServiceImpl {
    ...
    public void sendTestDataToEmail(String email){
       ...
       // String filename= System.getProperty("user.dir") + "/src/main/resources/temp/RequstedTestData" + email.split("@")[0] + ".xlsx";
        ...
        try {
            ...
            message.setSubject("Test Data");

            messageBodyPart1.setText("Good day, "+"\n\n"+" Find attached requested test data. \n\n Kind regards \n " +
    ...
    public void sendManualRequestTestDataToEmail(String email, String name){
       ...
       // System.out.println(email);
        ...
        try {
            ...
            message.setSubject("Test Data Manual Request");

            messageBodyPart1.setText("Good day, "+"\n\n"+" Find attached requested Template for Manual test data. \n\n Kind regards \n " +
            name);


            DataSource source = new FileDataSource(filename);
            messageBodyPart2.setDataHandler(new DataHandler(source));
            messageBodyPart2.setFileName("ManualTestDataTemplate.xls");
