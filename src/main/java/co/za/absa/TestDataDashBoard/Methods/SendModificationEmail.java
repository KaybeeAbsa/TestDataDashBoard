...
public class SendModificationEmail {
    public void sendTestDataToEmail(String email, String ScrumMaster, int token){
        ...
        try {
            ...
            messageBodyPart1.setText("Good day, "+"\n\n"+"Please note a modification was made to "+token+ "\nhttp://22.242.79.121:8081/TestDataDashBoard/homepage "+ "\r\n" +"Please use token " +token+ " to access the authorization request."+"\n\n" +"Kind Regards,"+ "\n" +ScrumMaster);
